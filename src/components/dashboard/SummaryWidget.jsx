...
export default function SummaryWidget({ userData, statsData, summaryLoading }) {
  console.log('==================================');
  ...
  const data = userData;
  const reimbursementStats = statsData;
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
        <Card>
          ...
          <CardContent className="px-4 pb-4">
            <div
              ...
              title={formatCurrency(reimbursementStats.lastAmount)}
            >
        ...
        <Card>
          ...
          <CardContent className="px-4 pb-4">
            <div
              className="text-sm font-bold truncate"
              title={formatCurrency(reimbursementStats.lastApprovedAmount)}
            >
        ...
        <Card>
          ...
          <CardContent className="px-4 pb-4">
            <div
              className="text-sm font-bold truncate"
              title={formatCurrency(reimbursementStats.lastRejectedAmount)}
            >
