        ...
        <Table>
          <TableHeader className="bg-slate-100/60 border-b border-gray-100">
            <TableRow className="border-none hover:bg-transparent">
              <TableHead className="w-[15%] uppercase text-[11px] font-bold text-gray-500 tracking-wider h-12 pl-6">
                Reference ID
              </TableHead>
              <TableHead className="w-[35%] uppercase text-[11px] font-bold text-gray-500 tracking-wider h-12">
                Title
              </TableHead>
              <TableHead className="w-[20%] uppercase text-[11px] font-bold text-gray-500 tracking-wider h-12">
                Date
              </TableHead>
              <TableHead className="w-[15%] uppercase text-[11px] font-bold text-gray-500 tracking-wider h-12">
                Amount
              </TableHead>
              <TableHead className="w-[15%] uppercase text-[11px] font-bold text-gray-500 tracking-wider h-12 pr-6">
                Status
              </TableHead>
            </TableRow>
          </TableHeader>
